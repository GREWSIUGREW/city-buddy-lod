...
- Sự phân mảnh thông tin: Dữ liệu về chất lượng không khí (OpenAQ), vị trí công viên (OpenStreetMap) và mật độ dân cư (Wikidata) tồn tại rời rạc. Người dân không có công cụ để biết chính xác nơi nào đáng sống dựa trên sự kết hợp của tất cả các yếu tố này.
